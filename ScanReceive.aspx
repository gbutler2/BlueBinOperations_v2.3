<%@ Page Title="Scan Receive" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ScanReceive.aspx.vb" Inherits="ScanReceive" %>
...
<%-- Scanner --%> 
 ...
 <%-- Location --%>   
                ...
                <asp:TableCell Width="240px">
                    <asp:DropDownList ID="LocationDD"   Width="200px" AppendDataBoundItems="true" runat="server" DataSourceID="ScanReceiveLocationSource" DataTextField="LocationName" DataValueField="LocationID">
...
<asp:TableRow Height="10"></asp:TableRow>
 <asp:TableRow>
   ...
   <asp:SqlDataSource ID="ScanReceiveLocationSource" runat="server" ConnectionString="<%$ ConnectionStrings:Site_ConnectionString %>" SelectCommand="exec sp_SelectLocation"></asp:SqlDataSource>      
